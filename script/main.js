...
html.id === "senate" ? houseOrSenate = "senate" : html.id === "house" ? houseOrSenate = "house" : ""

let URLAPI = `https://api.propublica.org/congress/v1/113/${houseOrSenate}/members.json`
let init = {
    method: "GET",
    headers: {
